...
protected:
    TH1F* DecayChannel;
    TH1F* M_TstarTstar, *Pt_TstarTstar, *Pt_TstarTstar_Diff;
    TH1F* M_TstarAntiTstar_ratio, * Pt_TstarAntiTstar_ratio, *M_Tstar, *M_antiTstar, *M_Tstar_reco, *M_antiTstar_reco, *Pt_Tstar, *Pt_antiTstar, *phi_Tstar, *phi_antiTstar, *eta_Tstar, *eta_antiTstar, *Pt_Tstar_over_M_TstarTstar, *Pt_antiTstar_over_M_TstarTstar, *Pt_Tstar_over_shat, *Pt_antiTstar_over_shat;
    TH1F* M_top,*M_antitop, *Pt_top, *Pt_antitop, *eta_top, *eta_antitop, *phi_top, *phi_antitop, *diffabseta, *diffphi, *M_tAntiTstar_reco, *M_tTstar_reco, *Diff_Pt_gluon_top, *Diff_Pt_antigluon_antitop, *Diff_Pt_gluon_btop, *Diff_Pt_antigluon_bantitop, *Diff_Pt_gluon_WplusDecay1, *Diff_Pt_gluon_WplusDecay2, *Diff_Pt_antigluon_WminusDecay1, *Diff_Pt_antigluon_WminusDecay2, *Diff_Pt_antigluon_gluon, *Diff_Pt_bantitop_btop;
    TH1F* M_gluon, *Pt_gluon, *M_antigluon, *Pt_antigluon, *eta_gluon, *eta_antigluon, *phi_gluon, *phi_antigluon;
    ...
    TH1F* Diff_deltaR_leptonic, *Diff_deltaR_hadronic;
