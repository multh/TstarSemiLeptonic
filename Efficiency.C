...
TCanvas *c1 = new TCanvas("c1","c1",600,500);
 ...
 TFile *s1 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.Tstar_M1000.root");
 ...
 TFile *b5 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.SingleTop.root");
 TFile *b6 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.Diboson.root");
...
THStack *hs = new THStack("hs","Efficiency Histogram");
 ...
 Double_t Eff4_signal = jet2_signal/Input_signal;
 ...
 Double_t Eff1_TTbar = Trigger_TTbar/Input;
 Double_t Eff2_TTbar = Lep1_TTbar/Input;
 Double_t Eff3_TTbar = twodcut_TTbar/Input;
 Double_t Eff4_TTbar = jet2_TTbar/Input;
 Double_t Eff5_TTbar = bTag_TTbar/Input;
 Double_t Eff6_TTbar = ht_TTbar/Input;

TH1F *h_Eff_TTbar = new TH1F("h_Eff_TTbar","h_Eff_TTbar",6,0,6);
 ...
 Double_t Eff1_WJets = Trigger_WJets/Input;
 Double_t Eff2_WJets = Lep1_WJets/Input;
 Double_t Eff3_WJets = twodcut_WJets/Input;
 Double_t Eff4_WJets = jet2_WJets/Input;
 Double_t Eff5_WJets = bTag_WJets/Input;
 Double_t Eff6_WJets = ht_WJets/Input;
...
TH1F *h_Eff_WJets = new TH1F("h_Eff_WJets","h_Eff_WJets",6,0,6);
 ...
 Double_t Eff4_QCD = jet2_QCD/Input;
...
TH1F *h_Eff_QCD = new TH1F("h_Eff_QCD","h_Eff_QCD",6,0,6);
 ...
 Double_t Eff4_ZJets = jet2_ZJets/Input;
...
TH1F *h_Eff_ZJets = new TH1F("h_Eff_ZJets","h_Eff_ZJets",6,0,6);
 ...
 TH1F *h_SingleTop2    = (TH1F*)b5->Get("lep1_Event/HT");
 TH1F *h_SingleTop3    = (TH1F*)b5->Get("twodcut_Event/HT");
 TH1F *h_SingleTop4    = (TH1F*)b5->Get("jet2_Event/HT");
 TH1F *h_SingleTop5    = (TH1F*)b5->Get("bTag_Event/HT");
 TH1F *h_SingleTop6    = (TH1F*)b5->Get("ht_Event/HT");
 ...
 Double_t jet2_SingleTop    = h_SingleTop4->GetEntries();
 ...
 Double_t Eff4_SingleTop = jet2_SingleTop/Input;
