...
void CorrMatchMacro() {
 ...
 TH1F *h1    = (TH1F*)s1->Get("corrmatch__HypHists/M_toplep");
 TH1F *h2    = (TH1F*)s2->Get("corrmatch__HypHists/M_toplep");
 TH1F *h3    = (TH1F*)s3->Get("corrmatch__HypHists/M_toplep");
 TH1F *h4    = (TH1F*)s4->Get("corrmatch__HypHists/M_toplep");
 TH1F *h5    = (TH1F*)s5->Get("corrmatch__HypHists/M_toplep");
 TH1F *h6    = (TH1F*)s6->Get("corrmatch__HypHists/M_toplep");
 TH1F *h7    = (TH1F*)s7->Get("corrmatch__HypHists/M_toplep");
 TH1F *h8    = (TH1F*)s8->Get("corrmatch__HypHists/M_toplep");
 TH1F *h9    = (TH1F*)s9->Get("corrmatch__HypHists/M_toplep");
 TH1F *h10   = (TH1F*)s10->Get("corrmatch__HypHists/M_toplep");
