...
TCanvas *c1 = new TCanvas("c1","c1",600,500);
 ...
 TFile *s1 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.Tstar_M700.root");
 TFile *b1 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.TTbar.root");
 TFile *b2 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.WJets.root");
 TFile *b3 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.QCD.root");
 TFile *b4 = new TFile("/nfs/dust/cms/user/multh/RunII_76X_v1/Selection/Mu_noIso_mediumBTag/uhh2.AnalysisModuleRunner.MC.ZJets.root");


THStack *hs = new THStack("hs","Background Composition");
 
 TH1F *h_signal0    = (TH1F*)s1->Get("input_Event/HT");
 TH1F *h_signal1    = (TH1F*)s1->Get("trigger_Event/HT");
 TH1F *h_signal2    = (TH1F*)s1->Get("lep1_Event/HT");
 TH1F *h_signal3    = (TH1F*)s1->Get("twodcut_Event/HT");
 TH1F *h_signal4    = (TH1F*)s1->Get("jet2_Event/HT");
 TH1F *h_signal5    = (TH1F*)s1->Get("bTag_Event/HT");
 TH1F *h_signal6    = (TH1F*)s1->Get("ht_Event/HT");
 TH1F *h_signal7    = (TH1F*)s1->Get("output_Event/HT");



 TH1F *h_TTbar0    = (TH1F*)b1->Get("input_Event/HT");
 TH1F *h_TTbar1    = (TH1F*)b1->Get("trigger_Event/HT");
 TH1F *h_TTbar2    = (TH1F*)b1->Get("lep1_Event/HT");
 TH1F *h_TTbar3    = (TH1F*)b1->Get("twodcut_Event/HT");
 TH1F *h_TTbar4    = (TH1F*)b1->Get("jet2_Event/HT");
 TH1F *h_TTbar5    = (TH1F*)b1->Get("bTag_Event/HT");
 TH1F *h_TTbar6    = (TH1F*)b1->Get("ht_Event/HT");
 TH1F *h_TTbar7    = (TH1F*)b1->Get("output_Event/HT");
 
 TH1F *h_WJets1    = (TH1F*)b2->Get("trigger_Event/HT");
 TH1F *h_WJets2    = (TH1F*)b2->Get("lep1_Event/HT");
 TH1F *h_WJets3    = (TH1F*)b2->Get("twodcut_Event/HT");
 TH1F *h_WJets4    = (TH1F*)b2->Get("jet2_Event/HT");
 TH1F *h_WJets5    = (TH1F*)b2->Get("bTag_Event/HT");
 TH1F *h_WJets6    = (TH1F*)b2->Get("ht_Event/HT");
 TH1F *h_WJets7    = (TH1F*)b2->Get("output_Event/HT");

 TH1F *h_QCD1    = (TH1F*)b3->Get("trigger_Event/HT");
 TH1F *h_QCD2    = (TH1F*)b3->Get("lep1_Event/HT");
 TH1F *h_QCD3    = (TH1F*)b3->Get("twodcut_Event/HT");
 TH1F *h_QCD4    = (TH1F*)b3->Get("jet2_Event/HT");
 TH1F *h_QCD5    = (TH1F*)b3->Get("bTag_Event/HT");
 TH1F *h_QCD6    = (TH1F*)b3->Get("ht_Event/HT");
 TH1F *h_QCD7    = (TH1F*)b3->Get("output_Event/HT");


 TH1F *h_ZJets1    = (TH1F*)b4->Get("trigger_Event/HT");
 TH1F *h_ZJets2    = (TH1F*)b4->Get("lep1_Event/HT");
 TH1F *h_ZJets3    = (TH1F*)b4->Get("twodcut_Event/HT");
 TH1F *h_ZJets4    = (TH1F*)b4->Get("jet2_Event/HT");
 TH1F *h_ZJets5    = (TH1F*)b4->Get("bTag_Event/HT");
 TH1F *h_ZJets6    = (TH1F*)b4->Get("ht_Event/HT");
 TH1F *h_ZJets7    = (TH1F*)b4->Get("output_Event/HT");
 ...
 Double_t jet2_signal        = h_signal4->GetEntries();
 Double_t bTag_signal        = h_signal5->GetEntries();
 Double_t ht_signal          = h_signal6->GetEntries();
 Double_t output_signal      = h_signal7->GetEntries();
 ...
 Double_t jet2_TTbar    = h_TTbar4->GetEntries();
 Double_t jet2_WJets    = h_WJets4->GetEntries();
 Double_t jet2_QCD      = h_QCD4->GetEntries();
 Double_t jet2_ZJets    = h_ZJets4->GetEntries();
 ...
 Double_t output_TTbar      = h_TTbar7->GetEntries();
 Double_t output_WJets      = h_WJets7->GetEntries();
 Double_t output_QCD        = h_QCD7->GetEntries();
 Double_t output_ZJets      = h_ZJets7->GetEntries();



 Double_t Trigger_Input =  Trigger_TTbar+Trigger_WJets+Trigger_QCD+Trigger_ZJets; 
 ...
 Double_t jet2_Input =  jet2_TTbar+jet2_WJets+jet2_QCD+jet2_ZJets; 
 ...
 Double_t Trigger_Ratio = Trigger_signal/sqrt(Trigger_Input);
 Double_t Lep1_Ratio    = Lep1_signal/sqrt(Lep1_Input);
 Double_t twodcut_Ratio = twodcut_signal/sqrt(twodcut_Input);
 Double_t jet2_Ratio = jet2_signal/sqrt(jet2_Input);
 ...
 Double_t Eff1_TTbar = Trigger_TTbar/Trigger_Input;
 Double_t Eff2_TTbar = Lep1_TTbar/Lep1_Input;
 Double_t Eff3_TTbar = twodcut_TTbar/twodcut_Input;
 Double_t Eff4_TTbar = jet2_TTbar/jet2_Input;
 ...
 Double_t Eff1_WJets = Trigger_WJets/Trigger_Input;
 Double_t Eff2_WJets = Lep1_WJets/Lep1_Input;
 Double_t Eff3_WJets = twodcut_WJets/twodcut_Input;
 Double_t Eff4_WJets = jet2_WJets/jet2_Input;
...
TH1F *h_Ratio = new TH1F("h_Ratio","S/#sqrt{B}",7,0,7);
 h_Ratio->SetBinContent(1,Trigger_Ratio);
 h_Ratio->SetBinContent(2,Lep1_Ratio);
 h_Ratio->SetBinContent(3,twodcut_Ratio);
  h_Ratio->SetBinContent(4,jet2_Ratio);
 h_Ratio->SetBinContent(5,bTag_Ratio);
 h_Ratio->SetBinContent(6,ht_Ratio);
  h_Ratio->SetBinContent(7,output_Ratio);

 h_Ratio->GetXaxis()->SetBinLabel(1,"Trigger");
